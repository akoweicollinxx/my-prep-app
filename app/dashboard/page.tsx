  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen grid place-items-center px-4 md:px-6 py-8 md:py-12 overflow-y-auto">
        <section className="bg-gradient-to-br from-black/80 via-purple-900/50 to-black/80 backdrop-blur-xl border border-purple-500/30 text-white p-6 md:p-10 rounded-3xl max-w-5xl w-full shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-10 relative overflow-hidden">
          ...
          {/* <button
            ...
            className="absolute bottom-6 right-6 cursor-pointer bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-sm py-2 px-5 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 border border-red-400/50"
          >
